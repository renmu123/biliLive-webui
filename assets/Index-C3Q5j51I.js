import { aX as Symbol$1, aY as isArray, aZ as isArguments, a_ as isSymbol, a$ as arrayMap, b0 as identity, b1 as baseUnary, b2 as baseRest, b3 as isIterateeCall, k as api, d as defineComponent, c as createElementBlock, e as createBaseVNode, o as openBlock, al as mergeModels, am as useModel, r as ref, x as computed, Y as watch, g as createBlock, w as withCtx, ar as __unplugin_components_3, a as createVNode, f as unref, i as isRef, j as createTextVNode, at as normalizeStyle, _ as __unplugin_components_3$1, aB as withKeys, B as Button, h as createCommentVNode, au as toRaw, an as storeToRefs, F as Fragment, t as toDisplayString, ao as renderList, aV as reactive, aF as renderSlot, aC as onActivated, as as useThemeStore, S as inject, aU as withModifiers, ap as normalizeClass, b4 as Qe, l as h$1, H as withDirectives, K as vShow, aq as nextTick, aD as onDeactivated, aE as onUnmounted, ax as onMounted, E as provide } from "./index-CB8xvhFr.js";
import { b as toReactive, w as watchThrottled, e as useWindowSize, f as useDraggable, d as useEventListener, a as useStorage } from "./index-CMOU2boc.js";
import { u as uuid, c as filenamify, h as secondsToTimemark, d as deepRaw, i as generateDistinctColor, a as supportedVideoExtensions } from "./index-guw4y6OO.js";
...
import { c as cloneDeep, h as useFfmpegPreset, d as useAppConfig, k as useSegmentStore, e as ffmpegPreset, t as task, l as useUploadPreset, a as useUserInfoStore, v as videoPreset, j as bili, m as useSubtitles, P as Parser } from "./index-FWk7a7hG.js";
import { _ as _sfc_main$b } from "./Tip.vue_vue_type_script_setup_true_lang-BVeN5TP1.js";
...
import { _ as __unplugin_components_0, a as __unplugin_components_5$3 } from "./Select-CYnthXY-.js";
import { b as __unplugin_components_5, _ as __unplugin_components_2 } from "./Switch-n0tH4Ke1.js";
...
import { _ as __unplugin_components_2$1, a as __unplugin_components_6, b as __unplugin_components_2$5 } from "./BiliSetting-Wua-gkDk.js";
...
import { s as showDirectoryDialog, b as showSaveDialog, a as showFileDialog } from "./fileSystem-DjZBa11j.js";
...
import { _ as __unplugin_components_5$1, a as __unplugin_components_3$2 } from "./RadioGroup-CJq397k5.js";
import { _ as __unplugin_components_2$3 } from "./Space-Dcg2rQj1.js";
import { N as NIcon } from "./Icon-D1o4HjX4.js";
import { _ as _sfc_main$c, S as SettingsOutline, a as __unplugin_components_8 } from "./BiliPresetEditDialog.vue_vue_type_script_setup_true_lang-StI16Ew5.js";
import { A as AddCircleOutline, _ as __unplugin_components_1$3 } from "./AddCircleOutline-Cb79zYrK.js";
import { b as baseGet, a as baseIteratee, c as baseMap, _ as __unplugin_components_2$4 } from "./Popover-D4v8saSe.js";
...
import { _ as _sfc_main$d } from "./Index.vue_vue_type_style_index_0_lang-CddyytYf.js";
import { F as FileArea, u as useDrive } from "./drive-NTdViwE0.js";
import { u as useNotice } from "./useNotice-D8AmCNaE.js";
import { N as NText } from "./text-BHgaUKrH.js";
import { _ as __unplugin_components_5$4 } from "./Dropdown-CwFZzQPI.js";
import { a as arrayPush } from "./_getTag-22mR82vJ.js";
import { _ as __unplugin_components_1$4 } from "./Tooltip-VU4s6Ip5.js";
...
const list = async () => {
  const res = await api.get(`/preset/subtitle-style`);
  return res.data;
};
const get = async (id) => {
  const res = await api.get(`/preset/subtitle-style/${id}`);
  return res.data;
};
const add = async (preset) => {
  return api.post(`/preset/subtitle-style`, preset);
};
const remove = async (id) => {
  return api.delete(`/preset/subtitle-style/${id}`);
};
const update = async (id, preset) => {
  return api.put(`/preset/subtitle-style/${id}`, preset);
};
...
const songRecognize = async (file, startTime, endTime) => {
  const res = await api.post("/ai/song-recognize", {
    file,
    startTime,
    endTime
  });
...
const EllipsisVertical = defineComponent({
...
const _hoisted_2$9 = { style: { "display": "flex", "gap": "20px" } };
const _hoisted_3$8 = { style: { "flex": "1", "overflow-y": "auto", "max-height": "calc(85vh - 150px)" } };
const _hoisted_4$7 = { style: { "flex": "1", "display": "flex", "flex-direction": "column" } };
const _hoisted_5$7 = { style: { "flex": "1", "background": "skyblue", "border-radius": "8px", "position": "relative", "min-height": "300px", "overflow": "hidden" } };
const _hoisted_6$4 = { class: "footer" };
const _hoisted_7$3 = { style: { "text-align": "right" } };
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  __name: "SubtitleStyleModal",
  props: {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const updateItalic = (val) => {
      styleConfig.value.italic = val ? -1 : 0;
    };
    const updateUnderline = (val) => {
    ...
    const loadPresets = async () => {
      try {
        const presets = await subtitleStylePreset.list();
        presetOptions.value = presets.map((p2) => ({
          label: p2.name,
          value: p2.id
        }));
      } catch (error) {
    ...
    const previewTextStyle = computed(() => {
      ...
      return {
        ...
        fontWeight: styleConfig.value.bold === -1 ? "bold" : "normal",
        fontStyle: styleConfig.value.italic === -1 ? "italic" : "normal",
    ...
    watch(
      ...
      async (val) => {
        if (val) {
          ...
          try {
            currentPreset.value = await subtitleStylePreset.get(val);
    ...
    const saveConfig = async () => {
      await subtitleStylePreset.save({
        ...currentPreset.value,
    ...
    const deletePreset = async () => {
      ...
      if (!status) return;
      await subtitleStylePreset.remove(presetId.value);
    ...
    const saveConfirm = async () => {
      ...
      await subtitleStylePreset.save(preset);
    ...
    const handleActionClick = async (key2) => {
      switch (key2) {
        case "saveAnother":
          saveAs();
          break;
    ...
    return (_ctx, _cache) => {
      ...
      const _component_n_color_picker = __unplugin_components_2$1;
      ...
      return openBlock(), createBlock(_component_n_modal, {
        show: visible.value,
        "onUpdate:show": _cache[18] || (_cache[18] = ($event) => visible.value = $event),
        "show-icon": false,
        closable: false,
        "auto-focus": ""
      }, {
        default: withCtx(() => [
          createVNode(_component_n_card, {
            ...
            header: withCtx(() => _cache[19] || (_cache[19] = [
              createBaseVNode("h3", { style: { "margin": "0" } }, "字幕样式配置", -1)
            ])),
            footer: withCtx(() => [
              createBaseVNode("div", _hoisted_6$4, [
                _cache[33] || (_cache[33] = createBaseVNode("div", { style: { "flex": "1" } }, null, -1)),
                unref(presetId) !== "default" ? (openBlock(), createBlock(_component_n_button, {
                  key: 0,
                  text: "",
                  class: "btn",
                  type: "error",
            ...
            default: withCtx(() => [
              createBaseVNode("div", _hoisted_1$a, [
                _cache[20] || (_cache[20] = createBaseVNode("span", { style: { "flex": "none" } }, "预设", -1)),
                createVNode(_component_n_select, {
                  value: unref(presetId),
                  "onUpdate:value": _cache[0] || (_cache[0] = ($event) => isRef(presetId) ? presetId.value = $event : null),
              ...
              createBaseVNode("div", _hoisted_2$9, [
                createBaseVNode("div", _hoisted_3$8, [
                  createVNode(_component_n_form, {
                    ...
                    default: withCtx(() => [
                      createVNode(_component_n_divider, { style: { "margin": "10px 0" } }, {
                        default: withCtx(() => _cache[21] || (_cache[21] = [
                          createTextVNode("字体设置")
                        ])),
                        _: 1
                      }),
                      createVNode(_component_n_form_item, { label: "字体名称" }, {
                        default: withCtx(() => [
                          createVNode(_component_n_select, {
                            value: unref(styleConfig).fontName,
                            "onUpdate:value": _cache[1] || (_cache[1] = ($event) => unref(styleConfig).fontName = $event),
                      ...
                      createVNode(_component_n_form_item, { label: "字体大小" }, {
                        default: withCtx(() => [
                          createVNode(_component_n_input_number, {
                            value: unref(styleConfig).fontSize,
                            "onUpdate:value": _cache[2] || (_cache[2] = ($event) => unref(styleConfig).fontSize = $event),
                            min: 8,
                            max: 100,
                            step: 1,
                            style: { "width": "100%" }
                      ...
                      createVNode(_component_n_form_item, { label: "粗体" }, {
                        default: withCtx(() => [
                          createVNode(_component_n_checkbox, {
                            checked: unref(isBold),
                            "onUpdate:checked": [
                              _cache[3] || (_cache[3] = ($event) => isRef(isBold) ? isBold.value = $event : null),
                              updateBold
                            ]
                          }, {
                            default: withCtx(() => _cache[22] || (_cache[22] = [
                              createTextVNode(" 启用粗体 ")
                            ])),
                            _: 1
                          }, 8, ["checked"])
                        ]),
                      ...
                      createVNode(_component_n_form_item, { label: "斜体" }, {
                        default: withCtx(() => [
                          createVNode(_component_n_checkbox, {
                            checked: unref(isItalic),
                            "onUpdate:checked": [
                              _cache[4] || (_cache[4] = ($event) => isRef(isItalic) ? isItalic.value = $event : null),
                              updateItalic
                            ]
                          }, {
                            default: withCtx(() => _cache[23] || (_cache[23] = [
                              createTextVNode(" 启用斜体 ")
                            ])),
                            _: 1
                          }, 8, ["checked"])
                        ]),
                      ...
                      createVNode(_component_n_form_item, { label: "下划线" }, {
                        default: withCtx(() => [
                          createVNode(_component_n_checkbox, {
                            checked: unref(isUnderline),
                            "onUpdate:checked": [
                              _cache[5] || (_cache[5] = ($event) => isRef(isUnderline) ? isUnderline.value = $event : null),
                              updateUnderline
                            ]
                          }, {
                            default: withCtx(() => _cache[24] || (_cache[24] = [
                              createTextVNode(" 启用下划线 ")
                            ])),
                            _: 1
                          }, 8, ["checked"])
                        ]),
                      ...
                      createVNode(_component_n_divider, { style: { "margin": "10px 0" } }, {
                        default: withCtx(() => _cache[25] || (_cache[25] = [
                          createTextVNode("颜色设置")
                        ])),
                        _: 1
                      }),
                      createVNode(_component_n_form_item, { label: "文字颜色" }, {
                        default: withCtx(() => [
                          createVNode(_component_n_color_picker, {
                            value: unref(styleConfig).primaryColour,
                            "onUpdate:value": _cache[6] || (_cache[6] = ($event) => unref(styleConfig).primaryColour = $event),
                            modes: ["hex"]
                          }, null, 8, ["value"])
                        ]),
                        _: 1
                      }),
                      createVNode(_component_n_form_item, { label: "边框颜色" }, {
                        default: withCtx(() => [
                          createVNode(_component_n_color_picker, {
                            value: unref(styleConfig).outlineColour,
                            "onUpdate:value": _cache[7] || (_cache[7] = ($event) => unref(styleConfig).outlineColour = $event),
                            modes: ["hex"]
                          }, null, 8, ["value"])
                        ]),
                        _: 1
                      }),
                      createVNode(_component_n_form_item, { label: "阴影颜色" }, {
                        default: withCtx(() => [
                          createVNode(_component_n_color_picker, {
                            value: unref(styleConfig).backColour,
                            "onUpdate:value": _cache[8] || (_cache[8] = ($event) => unref(styleConfig).backColour = $event),
                            modes: ["hex"]
                          }, null, 8, ["value"])
                        ]),
                        _: 1
                      ...
                      createVNode(_component_n_divider, { style: { "margin": "10px 0" } }, {
                        default: withCtx(() => _cache[26] || (_cache[26] = [
                          createTextVNode("边框和阴影")
                        ])),
                        _: 1
                      }),
                      createVNode(_component_n_form_item, { label: "边框宽度" }, {
                        default: withCtx(() => [
                          createVNode(_component_n_slider, {
                            value: unref(styleConfig).outline,
                            "onUpdate:value": _cache[9] || (_cache[9] = ($event) => unref(styleConfig).outline = $event),
                            min: 0,
                            max: 10,
                            step: 0.5,
                      ...
                      createVNode(_component_n_form_item, { label: "阴影距离" }, {
                        default: withCtx(() => [
                          createVNode(_component_n_slider, {
                            value: unref(styleConfig).shadow,
                            "onUpdate:value": _cache[10] || (_cache[10] = ($event) => unref(styleConfig).shadow = $event),
                            min: 0,
                            max: 10,
                            step: 0.5,
                      ...
                      createVNode(_component_n_divider, { style: { "margin": "10px 0" } }, {
                        default: withCtx(() => _cache[27] || (_cache[27] = [
                          createTextVNode("位置设置")
                        ])),
                        _: 1
                      }),
                      createVNode(_component_n_form_item, { label: "对齐方式" }, {
                        default: withCtx(() => [
                          createVNode(_component_n_select, {
                            value: unref(styleConfig).alignment,
                            "onUpdate:value": _cache[11] || (_cache[11] = ($event) => unref(styleConfig).alignment = $event),
                            options: alignmentOptions
                          }, null, 8, ["value"])
                        ]),
                        _: 1
                      }),
                      createVNode(_component_n_form_item, { label: "左边距" }, {
                        default: withCtx(() => [
                          createVNode(_component_n_input_number, {
                            value: unref(styleConfig).marginL,
                            "onUpdate:value": _cache[12] || (_cache[12] = ($event) => unref(styleConfig).marginL = $event),
                            min: 0,
                            max: 500,
                            step: 5,
                            style: { "width": "100%" }
                      ...
                      createVNode(_component_n_form_item, { label: "右边距" }, {
                        default: withCtx(() => [
                          createVNode(_component_n_input_number, {
                            value: unref(styleConfig).marginR,
                            "onUpdate:value": _cache[13] || (_cache[13] = ($event) => unref(styleConfig).marginR = $event),
                            min: 0,
                            max: 500,
                            step: 5,
                            style: { "width": "100%" }
                      ...
                      createVNode(_component_n_form_item, { label: "垂直边距" }, {
                        default: withCtx(() => [
                          createVNode(_component_n_input_number, {
                            value: unref(styleConfig).marginV,
                            "onUpdate:value": _cache[14] || (_cache[14] = ($event) => unref(styleConfig).marginV = $event),
                            min: 0,
                            max: 500,
                            step: 5,
                            style: { "width": "100%" }
                ...
                createBaseVNode("div", _hoisted_4$7, [
                  _cache[28] || (_cache[28] = createBaseVNode("div", { style: { "margin-bottom": "10px", "font-weight": "bold" } }, "预览效果", -1)),
                  createBaseVNode("div", _hoisted_5$7, [
                    createBaseVNode("div", {
                      style: normalizeStyle(unref(previewContainerStyle))
                    }, [
                      createBaseVNode("div", {
                        style: normalizeStyle(unref(previewTextStyle))
                      }, "这是字幕预览效果", 4),
                      createBaseVNode("div", {
                        style: normalizeStyle(unref(previewTextStyle))
                      }, "Subtitle Preview", 4)
                  ...
                  _cache[29] || (_cache[29] = createBaseVNode("div", { style: { "margin-top": "10px", "font-size": "12px", "color": "#999" } }, " 提示：预览效果为近似效果，实际渲染以ffmpeg为准 ", -1))
                ])
              ]),
...
const SubtitleStyleModal = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-1a8ec4c0"]]);
const _hoisted_1$9 = { style: { "display": "flex", "flex-direction": "column", "gap": "10px" } };
const _hoisted_2$8 = { style: { "color": "skyblue" } };
const _hoisted_3$7 = {
  key: 0,
...
const _hoisted_6$3 = { style: { "display": "flex", "align-items": "center", "gap": "10px", "margin-top": "10px" } };
const _hoisted_7$2 = { style: { "margin-bottom": "5px" } };
const _hoisted_8$2 = { style: { "color": "red" } };
const _hoisted_9$2 = ["title", "onClick"];
const _hoisted_10$2 = { class: "footer" };
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const currentSubtitleStyle = ref();
      ...
      for (const cut of selectedCuts.value) {
        ...
        await task.cut(
          ...
          `${title}.mp4`,
          {
            ...
            ss: start,
            to: end,
            subtitleOptions: exportOptions.ignoreSubtitle ? void 0 : currentSubtitleStyle.value
          },
          {
    ...
    const initSubtitleStyle = async () => {
      ...
      const data = await subtitleStylePreset.get(styleId);
      currentSubtitleStyle.value = data.config;
    };
    const handleSubtitleStyleConfirm = async (config) => {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_Tip = _sfc_main$b;
      const _component_n_radio = __unplugin_components_3$2;
      const _component_n_input = __unplugin_components_2$2;
      const _component_n_icon = NIcon;
      const _component_n_space = __unplugin_components_2$3;
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(_component_n_modal, {
          show: visible.value,
          "onUpdate:show": _cache[10] || (_cache[10] = ($event) => visible.value = $event),
          "show-icon": false,
          closable: false,
          "auto-focus": ""
        }, {
            ...
            createVNode(_component_n_card, {
              ...
              footer: withCtx(() => [
                createBaseVNode("div", _hoisted_10$2, [
                  createVNode(_component_n_button, {
                    class: "btn",
                    onClick: _cache[9] || (_cache[9] = ($event) => visible.value = false)
                  }, {
                    default: withCtx(() => _cache[23] || (_cache[23] = [
                      createTextVNode("取消")
                    ])),
              ...
              default: withCtx(() => [
                createBaseVNode("div", _hoisted_1$9, [
                  createBaseVNode("h3", null, [
                    ...
                    createBaseVNode("span", _hoisted_2$8, toDisplayString(unref(selectedCuts).length), 1),
                    _cache[12] || (_cache[12] = createTextVNode(" 个视频 "))
                  ]),
                  unref(noDanmuTips) ? (openBlock(), createElementBlock("p", _hoisted_3$7, toDisplayString(unref(noDanmuTips)), 1)) : createCommentVNode("", true),
                  createBaseVNode("div", _hoisted_4$6, [
                    _cache[14] || (_cache[14] = createTextVNode(" 选择视频预设： ")),
                  ...
                  createBaseVNode("div", null, [
                    createVNode(_component_n_checkbox, {
                      ...
                      default: withCtx(() => _cache[18] || (_cache[18] = [
                        createTextVNode(" 忽略弹幕渲染 ")
                      ])),
                      _: 1
                    }, 8, ["checked"]),
                    createBaseVNode("div", _hoisted_6$3, [
                      createVNode(_component_n_checkbox, {
                        checked: unref(exportOptions).ignoreSubtitle,
                        "onUpdate:checked": _cache[5] || (_cache[5] = ($event) => unref(exportOptions).ignoreSubtitle = $event)
                      }, {
                        default: withCtx(() => _cache[19] || (_cache[19] = [
                          createTextVNode(" 忽略字幕渲染 ")
                        ])),
                        _: 1
                      }, 8, ["checked"]),
                      createVNode(_component_n_button, {
                        size: "small",
                        onClick: _cache[6] || (_cache[6] = ($event) => showSubtitleStyleModal.value = true)
                      }, {
                        default: withCtx(() => _cache[20] || (_cache[20] = [
                          createTextVNode(" 配置字幕样式 ")
                        ])),
                        _: 1
                      })
                    ]),
                    createVNode(_component_n_checkbox, {
                      ...
                      "onUpdate:checked": _cache[7] || (_cache[7] = ($event) => unref(exportOptions).exportSubtitle = $event),
                      style: { "margin-top": "10px" }
                    }, {
                      default: withCtx(() => _cache[21] || (_cache[21] = [
                        createTextVNode(" 单独导出srt字幕 ")
                      ])),
                      _: 1
                    }, 8, ["checked"])
                  ]),
                  createBaseVNode("div", null, [
                    createBaseVNode("div", _hoisted_7$2, [
                      _cache[22] || (_cache[22] = createTextVNode(" 输出文件名：")),
                      createBaseVNode("span", _hoisted_8$2, toDisplayString(unref(exportError)), 1)
                    ]),
                    createBaseVNode("div", null, [
                      createVNode(_component_n_input, {
                        value: unref(exportOptions).title,
                        "onUpdate:value": _cache[8] || (_cache[8] = ($event) => unref(exportOptions).title = $event),
                        placeholder: "请输入视频标题",
                        clearable: "",
                      ...
                      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(titleList), (item) => {
                        ...
                        }, toDisplayString(item.value), 9, _hoisted_9$2);
                      }), 128))
                    ])
                  ])
                ])
        ...
        createVNode(SubtitleStyleModal, {
          modelValue: unref(showSubtitleStyleModal),
          "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => isRef(showSubtitleStyleModal) ? showSubtitleStyleModal.value = $event : null),
          "initial-config": unref(currentSubtitleStyle),
          onConfirm: handleSubtitleStyleConfirm
        }, null, 8, ["modelValue", "initial-config"])
      ], 64);
    };
  }
});
const ExportModal = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-3918b672"]]);
const _hoisted_1$8 = { class: "form-row" };
const _hoisted_2$7 = { class: "form-row" };
const _hoisted_3$6 = { class: "form-column" };
const _hoisted_4$5 = { class: "form-row" };
const _hoisted_5$5 = { class: "footer" };
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  __name: "ExportUploadModal",
  props: /* @__PURE__ */ mergeModels({
    files: { default: () => ({
      danmuPath: null,
      originVideoPath: null
  ...
  setup(__props) {
    ...
    const confirmExportAndUpload = async () => {
      ...
      if (currentSegment.value.end === void 0) {
        notice.error({
          title: "当前切片缺少结束时间",
          duration: 1e3
        });
      ...
      try {
        const ffmpegPreset$1 = await ffmpegPreset.get(exportOptions.ffmpegPresetId);
        const ffmpegPresetConfig = ffmpegPreset$1.config;
        let uploadConfig = null;
        if (exportOptions.uploadPresetId) {
          const uploadPreset = await videoPreset.get(exportOptions.uploadPresetId);
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
            ...
            createVNode(_component_n_card, {
              ...
              footer: withCtx(() => [
                createBaseVNode("div", _hoisted_5$5, [
                  ...
                  createVNode(_component_n_button, {
                    ...
                    onClick: confirmExportAndUpload
                  }, {
                    default: withCtx(() => _cache[17] || (_cache[17] = [
                      createTextVNode(" 确定 ")
                    ])),
              ...
              default: withCtx(() => [
                createVNode(_component_n_form, {
                  ...
                  default: withCtx(() => [
                    createVNode(_component_n_form_item, { label: "视频预设" }, {
                      default: withCtx(() => [
                        createBaseVNode("div", _hoisted_1$8, [
                          ...
                          createVNode(_component_Tip, null, {
                            default: withCtx(() => _cache[11] || (_cache[11] = [
                              createTextVNode(" 推荐采用质量模式，以自适应视频质量 ")
                            ])),
                            _: 1
                          })
                        ])
                    ...
                    createVNode(_component_n_form_item, { label: "上传预设" }, {
                      default: withCtx(() => [
                        createBaseVNode("div", _hoisted_2$7, [
                          createVNode(_component_n_select, {
                            value: unref(exportOptions).uploadPresetId,
                            "onUpdate:value": _cache[1] || (_cache[1] = ($event) => unref(exportOptions).uploadPresetId = $event),
                          ...
                          unref(exportOptions).uploadPresetId ? (openBlock(), createBlock(_component_n_button, {
                            key: 0,
                            text: "",
                            onClick: _cache[2] || (_cache[2] = ($event) => showUploadPresetDialog.value = true)
                          }, {
                            icon: withCtx(() => [
                    ...
                    createVNode(_component_n_form_item, { label: "其他" }, {
                      default: withCtx(() => [
                        createBaseVNode("div", _hoisted_3$6, [
                          createVNode(_component_n_checkbox, {
                            checked: unref(exportOptions).ignoreDanmu,
                            "onUpdate:checked": _cache[3] || (_cache[3] = ($event) => unref(exportOptions).ignoreDanmu = $event)
                          }, {
                          ...
                          createBaseVNode("div", _hoisted_4$5, [
                            createVNode(_component_n_checkbox, {
                              checked: unref(exportOptions).ignoreSubtitle,
                              "onUpdate:checked": _cache[4] || (_cache[4] = ($event) => unref(exportOptions).ignoreSubtitle = $event)
                            }, {
                              default: withCtx(() => _cache[13] || (_cache[13] = [
                                createTextVNode(" 忽略字幕渲染 ")
                              ])),
                            ...
                            createVNode(_component_n_button, {
                              size: "small",
                              onClick: _cache[5] || (_cache[5] = ($event) => showSubtitleStyleModal.value = true)
                            }, {
                          ...
                          createVNode(_component_n_checkbox, {
                            checked: unref(exportOptions).exportSubtitle,
                            "onUpdate:checked": _cache[6] || (_cache[6] = ($event) => unref(exportOptions).exportSubtitle = $event)
                          }, {
                            default: withCtx(() => _cache[15] || (_cache[15] = [
                              createTextVNode(" 单独导出srt字幕 ")
                            ])),
        ...
        createVNode(SubtitleStyleModal, {
          modelValue: unref(showSubtitleStyleModal),
          "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => isRef(showSubtitleStyleModal) ? showSubtitleStyleModal.value = $event : null),
          "initial-config": unref(currentSubtitleStyle),
          onConfirm: handleSubtitleStyleConfirm
        }, null, 8, ["modelValue", "initial-config"]),
        createVNode(_sfc_main$c, {
          show: unref(showUploadPresetDialog),
          "onUpdate:show": _cache[10] || (_cache[10] = ($event) => isRef(showUploadPresetDialog) ? showUploadPresetDialog.value = $event : null),
          "preset-id": unref(exportOptions).uploadPresetId
        }, null, 8, ["show", "preset-id"])
      ], 64);
    };
  }
});
const ExportUploadModal = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-a0fb16c0"]]);
const _hoisted_1$7 = { style: { "width": "600px" } };
const _hoisted_2$6 = { style: { "margin-top": "10px" } };
const _hoisted_3$5 = { style: { "flex": "none" } };
const _hoisted_4$4 = { style: { "color": "#2b94ff", "flex": "none" } };
const _hoisted_5$4 = {
  key: 0,
  style: { "color": "#e57272" }
};
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const list2 = computed(() => props.danmaList);
    ...
    const getDisplayList = () => {
      let data = list2.value;
      if (form.sc) {
        data = list2.value.filter((item) => item.type === "sc");
      }
      if (!form.value) {
    ...
    return (_ctx, _cache) => {
      const _component_n_input = __unplugin_components_2$2;
      const _component_n_button = Button;
      const _component_n_input_group = __unplugin_components_2$5;
      const _component_n_radio = __unplugin_components_3$2;
      const _component_n_space = __unplugin_components_2$3;
      const _component_n_radio_group = __unplugin_components_5$1;
      const _component_n_checkbox = __unplugin_components_1$2;
            ...
            createVNode(_component_n_virtual_list, {
              ...
              default: withCtx(({ item }) => [
                (openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", _hoisted_3$5, toDisplayString(unref(secondsToTimemark)(item.ts, false)), 1),
                  createBaseVNode("span", _hoisted_4$4, toDisplayString(item.user), 1),
                  item.type === "sc" ? (openBlock(), createElementBlock("span", _hoisted_5$4, "sc")) : createCommentVNode("", true),
...
const SearchPopover = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-e86ae3d7"]]);
const _hoisted_1$6 = { class: "cut-list" };
const _hoisted_2$5 = { class: "btns" };
const _hoisted_3$4 = {
  stroke: "currentColor",
  fill: "currentColor",
  "stroke-width": "0",
...
const _hoisted_4$3 = { class: "view" };
const _hoisted_5$3 = ["onClick", "onDblclick", "onContextmenu"];
const _hoisted_6$2 = { class: "time" };
const _hoisted_7$1 = {
  class: "name",
  style: { "color": "skyblue" }
};
...
const _hoisted_10$1 = { class: "edit-icon" };
...
识别范围：${segment.start.toFixed(2)}s - ${segment.end?.toFixed(2)}s`,
    ...
    const lyricRecognizeHandler = async (segment) => {
      if (!props.files.originVideoPath) {
        notice.error({
          title: "请先加载视频文件",
          duration: 1e3
        ...
        createBaseVNode("div", _hoisted_1$6, [
          createBaseVNode("div", _hoisted_2$5, [
            ...
            createVNode(unref(NIcon), {
              ...
              default: withCtx(() => [
                (openBlock(), createElementBlock("svg", _hoisted_3$4, _cache[6] || (_cache[6] = [
            ...
            createVNode(_component_Tip, { class: "cut-search-danmu" }, {
              default: withCtx(() => _cache[7] || (_cache[7] = [
                createBaseVNode("ul", null, [
                  ...
                  createBaseVNode("li", null, "j 减速"),
                  createBaseVNode("li", null, "k 暂停"),
                  createBaseVNode("li", null, "l 加速")
                ], -1)
              ])),
              _: 1
            })
...
const SegmentList = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-81bb77a1"]]);
const _hoisted_1$5 = { class: "video-section" };
const _hoisted_2$4 = { class: "video cut-video" };
...
const VideoPlayer = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-e0f5b0a2"]]);
const _hoisted_1$4 = { class: "config-section" };
const _hoisted_2$3 = { class: "waveform-container" };
const _hoisted_3$3 = {
  key: 0,
  class: "waveform-loading"
};
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  __name: "WaveformPanel",
  props: {
    waveformVisible: {
      type: Boolean,
      required: true
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$4, [
        withDirectives(createBaseVNode("div", _hoisted_2$3, [
          __props.waveformLoading ? (openBlock(), createElementBlock("div", _hoisted_3$3, [
            createVNode(_component_n_spin, { size: "small" }),
            _cache[0] || (_cache[0] = createBaseVNode("span", null, "波形图加载中...，请不要切换到其他页面", -1))
          ])) : createCommentVNode("", true),
          _cache[1] || (_cache[1] = createBaseVNode("div", { id: "waveform" }, null, -1))
        ], 512), [
...
const WaveformPanel = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-f5211e4b"]]);
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_n_form_item = __unplugin_components_2;
      const _component_n_checkbox = __unplugin_components_1$2;
      const _component_n_progress = __unplugin_components_1$3;
      const _component_n_form = __unplugin_components_5;
      const _component_n_button = Button;
      const _component_n_space = __unplugin_components_2$3;
      const _component_n_modal = __unplugin_components_3;
...
const WaveformAnalyzerDialog = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-9d8dd9dd"]]);
const _hoisted_1$2 = { class: "config-view" };
const _hoisted_2$2 = { class: "config-item" };
const _hoisted_3$2 = { class: "config-item" };
const _hoisted_4$2 = { class: "config-item" };
const _hoisted_5$2 = { class: "config-item" };
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "SegmentConfigView",
  props: {
    clientOptions: {
      type: Object,
      required: true
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        ...
        unref(hotProgressVisible) ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          createBaseVNode("div", _hoisted_2$2, [
            _cache[10] || (_cache[10] = createBaseVNode("span", null, "采样间隔：", -1)),
            createVNode(_component_n_input_number, {
          ...
          createBaseVNode("div", _hoisted_3$2, [
            _cache[12] || (_cache[12] = createBaseVNode("span", null, "高度：", -1)),
            createVNode(_component_n_input_number, {
          ...
          createBaseVNode("div", _hoisted_4$2, [
            _cache[13] || (_cache[13] = createBaseVNode("span", null, "默认颜色：", -1)),
            createVNode(_component_n_color_picker, {
          ...
          createBaseVNode("div", _hoisted_5$2, [
            _cache[14] || (_cache[14] = createBaseVNode("span", null, "覆盖颜色：", -1)),
            createVNode(_component_n_color_picker, {
...
const SegmentConfigView = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-da1735d5"]]);
const _hoisted_1$1 = { class: "subtitle-view" };
const _hoisted_2$1 = { class: "subtitle-header" };
const _hoisted_3$1 = { class: "subtitle-content" };
const _hoisted_4$1 = {
  key: 0,
  class: "empty-state"
};
...
const _hoisted_7 = { class: "node-body" };
const _hoisted_8 = { class: "node-text" };
const _hoisted_9 = { class: "node-right" };
const _hoisted_10 = { class: "node-times" };
const _hoisted_11 = {
  key: 0,
  class: "subtitle-footer"
};
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    watch(
      () => subtitleStore.items.map((i3) => i3.id + i3.content).join("|"),
      () => {
    ...
    function loadNodes(segmentId) {
      if (segmentId === "__global__") {
        ...
        try {
          nodes.value = parser.fromSrt(globalSubtitles[0].content);
        } catch {
          nodes.value = [];
        }
      ...
      try {
        nodes.value = parser.fromSrt(subtitles[0].content);
      } catch {
        nodes.value = [];
      }
    ...
    let isDirty = false;
    function updateNodeField(idx, field, value) {
      isDirty = true;
      nodes.value[idx][field] = value;
    }
    function deleteNode(idx) {
      nodes.value.splice(idx, 1);
      flushToStore();
    }
    function getNodeActions(idx) {
      return [
    ...
    function handleNodeAction(key2, idx) {
      switch (key2) {
        case "insert-before":
    ...
    function insertNode(idx, position) {
    ...
    function mergeNode(idx, direction) {
    ...
    function flushToStore() {
      ...
      const validNodes = nodes.value.map((n2) => ({
        ...n2,
        startSeconds: parseTimeToSeconds(n2.startTime),
        endSeconds: parseTimeToSeconds(n2.endTime)
      })).filter((n2) => n2.startSeconds < n2.endSeconds);
      ...
      validNodes.forEach((n2, i3) => {
        n2.id = String(i3 + 1);
      });
      try {
        const srtContent = parser.toSrt(validNodes);
        isFlushing = true;
        if (selectedSegmentId.value === "__global__") {
    ...
    function formatTime(seconds) {
      ...
      return `${String(h2).padStart(2, "0")}:${String(m2).padStart(2, "0")}:${String(s3).padStart(2, "0")},${String(ms).padStart(3, "0")}`;
    }
    ...
    return (_ctx, _cache) => {
      ...
      const _component_n_icon = NIcon;
      const _component_n_button = Button;
      const _component_n_dropdown = __unplugin_components_5$4;
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2$1, [
          createVNode(_component_n_select, {
            value: unref(selectedSegmentId),
            "onUpdate:value": _cache[0] || (_cache[0] = ($event) => isRef(selectedSegmentId) ? selectedSegmentId.value = $event : null),
            options: unref(segmentOptions),
            placeholder: "请选择片段",
            size: "small",
            clearable: ""
          }, null, 8, ["value", "options"])
        ...
        createBaseVNode("div", _hoisted_3$1, [
          !unref(selectedSegmentId) ? (openBlock(), createElementBlock("div", _hoisted_4$1, [
            createVNode(_component_n_empty, { description: "请先选择一个片段" })
          ])) : unref(nodes).length === 0 ? (openBlock(), createElementBlock("div", _hoisted_5$1, [
            createVNode(_component_n_empty, { description: "当前片段暂无字幕" })
          ])) : (openBlock(), createElementBlock("div", _hoisted_6$1, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(nodes), (node, idx) => {
              return openBlock(), createElementBlock("div", {
                key: idx,
                class: "node-item"
              }, [
                createBaseVNode("div", _hoisted_7, [
                  createBaseVNode("div", _hoisted_8, [
                    createVNode(_component_n_input, {
                      value: node.text,
                      class: "text-input",
                      "onUpdate:value": (v2) => updateNodeField(idx, "text", v2),
                      onBlur: handleBlur,
                      onDblclick: ($event) => seekVideo(node.startSeconds)
                    }, null, 8, ["value", "onUpdate:value", "onDblclick"])
                  ]),
                  createBaseVNode("div", _hoisted_9, [
                    createBaseVNode("div", _hoisted_10, [
                      createVNode(_component_n_input, {
                        ...
                        size: "tiny",
                        class: "time-input",
                        "onUpdate:value": (v2) => updateNodeField(idx, "startTime", v2),
                        onBlur: handleBlur
                      ...
                      createVNode(_component_n_input, {
                        ...
                        size: "tiny",
                        class: "time-input",
                        "onUpdate:value": (v2) => updateNodeField(idx, "endTime", v2),
                        onBlur: handleBlur
                      }, null, 8, ["value", "onUpdate:value"])
                    ])
                  ]),
                  createVNode(_component_n_dropdown, {
                    ...
                    onSelect: (key2) => handleNodeAction(key2, idx)
                  }, {
                    default: withCtx(() => [
                      createVNode(_component_n_button, {
                        text: "",
        ...
        unref(selectedSegmentId) ? (openBlock(), createElementBlock("div", _hoisted_11, [
          createVNode(_component_n_button, {
            size: "small",
            dashed: "",
            block: "",
            ...
            default: withCtx(() => [
              ...
              _cache[1] || (_cache[1] = createTextVNode(" 添加字幕行 "))
            ]),
            _: 1
          })
        ])) : createCommentVNode("", true)
...
const SubtitleView = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-1eb672ab"]]);
var Space_Separator = /[\u1680\u2000-\u200A\u202F\u205F\u3000]/;
  ...
  const loadProjectFile = async (filePath) => {
    try {
      ...
      if (projectData.subtitles && Array.isArray(projectData.subtitles)) {
        projectData.subtitles.forEach((subtitle) => {
...
function useChapter(videoInstance) {
  let segmentEventHandler = null;
  const segmentToChapter = (segment) => ({
    start: segment.start,
    end: segment.end ?? 0,
    title: segment.name,
  ...
  const updateAllChapters = () => {
    if (!videoInstance.value) return;
    const chapterPlugin = videoInstance.value?.artplayerPluginChapter;
...
const PLAYBACK_RATE_EPSILON = 1e-3;
function useKeyboardShortcuts(handlers, videoInstance) {
  const shouldIgnoreMediaShortcut = (event) => {
...
const _hoisted_3 = { class: "view-sidebar" };
const _hoisted_4 = { class: "view-content" };
const _hoisted_5 = { class: "btns page-header" };
const _hoisted_6 = { class: "segment-list-container" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const activeSegmentView = ref("cuts");
    ...
    const handleProjectMenuClick = async (key2) => {
      ...
      } else if (key2 === "importGlobalSubtitle") {
    ...
    const importGlobalSubtitle = async () => {
      ...
      const filePath = selectedFiles[0];
      try {
        const content = await common.readDanma(filePath);
    ...
    const currentUploadSegment = ref(null);
    ...
    const exportCutsAndUpload = async (segment) => {
      if (!files.value.videoPath) {
        notice.error({
          title: "请先选择视频文件",
          duration: 1e3
    ...
    return (_ctx, _cache) => {
      const _component_n_icon = NIcon;
      const _component_n_tooltip = __unplugin_components_1$4;
      const _component_n_button = Button;
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1, [
          createBaseVNode("div", _hoisted_2, [
            ...
            createBaseVNode("div", {
              ...
              style: normalizeStyle({ width: unref(segmentWidth) + "px" })
            }, [
              createBaseVNode("div", _hoisted_3, [
                createVNode(_component_n_tooltip, { placement: "left" }, {
                  trigger: withCtx(() => [
                    createBaseVNode("div", {
                      class: normalizeClass(["sidebar-icon", { active: unref(activeSegmentView) === "cuts" }]),
                      onClick: _cache[0] || (_cache[0] = ($event) => activeSegmentView.value = "cuts")
                    }, [
                      createVNode(_component_n_icon, { size: "18" }, {
                        default: withCtx(() => [
                          createVNode(unref(Cut))
                        ]),
                        _: 1
                      })
                    ], 2)
                  ...
                  default: withCtx(() => [
                    _cache[14] || (_cache[14] = createTextVNode(" 切片列表 "))
                  ]),
                  _: 1
                }),
                createVNode(_component_n_tooltip, { placement: "left" }, {
                  trigger: withCtx(() => [
                    createBaseVNode("div", {
                      class: normalizeClass(["sidebar-icon", { active: unref(activeSegmentView) === "config" }]),
                      onClick: _cache[1] || (_cache[1] = ($event) => activeSegmentView.value = "config")
                    }, [
                      createVNode(_component_n_icon, { size: "18" }, {
                        default: withCtx(() => [
                          createVNode(unref(SettingsOutline))
                  ...
                  default: withCtx(() => [
                    _cache[15] || (_cache[15] = createTextVNode(" 配置 "))
                  ]),
                  _: 1
                }),
                createVNode(_component_n_tooltip, { placement: "left" }, {
                  trigger: withCtx(() => [
                    createBaseVNode("div", {
                      class: normalizeClass(["sidebar-icon", { active: unref(activeSegmentView) === "subtitle" }]),
                      onClick: _cache[2] || (_cache[2] = ($event) => activeSegmentView.value = "subtitle")
                    }, [
                      createVNode(_component_n_icon, { size: "18" }, {
                        default: withCtx(() => [
                          createVNode(unref(DocumentTextOutline))
                        ]),
                        _: 1
                      })
                    ], 2)
                  ...
                  default: withCtx(() => [
                    _cache[16] || (_cache[16] = createTextVNode(" 字幕编辑 "))
                  ]),
                  _: 1
                })
              ]),
              createBaseVNode("div", _hoisted_4, [
                unref(activeSegmentView) === "cuts" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                  createBaseVNode("div", _hoisted_5, [
                    ...
                    createVNode(_component_n_button, {
                      ...
                      default: withCtx(() => [
                        ...
                        _cache[18] || (_cache[18] = createTextVNode(" 导出 "))
                      ]),
                      _: 1
                    }, 8, ["disabled"])
                  ]),
                  createBaseVNode("div", _hoisted_6, [
                    createVNode(SegmentList, {
                      ...
                      onExportUpload: exportCutsAndUpload
                    }, null, 8, ["danma-list", "files", "danmaSearchMask"])
                  ])
                ], 64)) : unref(activeSegmentView) === "config" ? (openBlock(), createBlock(SegmentConfigView, {
                  key: 1,
                  "client-options": unref(clientOptions),
                  "hot-progress-visible": unref(hotProgressVisible),
                  "onUpdate:hotProgressVisible": _cache[3] || (_cache[3] = ($event) => isRef(hotProgressVisible) ? hotProgressVisible.value = $event : null),
                  "show-video-time": unref(showVideoTime),
                  "onUpdate:showVideoTime": _cache[4] || (_cache[4] = ($event) => isRef(showVideoTime) ? showVideoTime.value = $event : null),
                  "danma-search-mask": unref(danmaSearchMask),
                  "onUpdate:danmaSearchMask": _cache[5] || (_cache[5] = ($event) => isRef(danmaSearchMask) ? danmaSearchMask.value = $event : null),
                  "waveform-visible": unref(waveformVisible),
                  "onUpdate:waveformVisible": _cache[6] || (_cache[6] = ($event) => isRef(waveformVisible) ? waveformVisible.value = $event : null)
                }, null, 8, ["client-options", "hot-progress-visible", "show-video-time", "danma-search-mask", "waveform-visible"])) : createCommentVNode("", true),
                withDirectives(createVNode(SubtitleView, null, null, 512), [
                  [vShow, unref(activeSegmentView) === "subtitle"]
                ])
              ])
            ], 4)
          ]),
          createVNode(WaveformPanel, {
            "waveform-visible": unref(waveformVisible),
            "onUpdate:waveformVisible": _cache[7] || (_cache[7] = ($event) => isRef(waveformVisible) ? waveformVisible.value = $event : null),
            "waveform-loading": unref(waveformLoading)
          }, null, 8, ["waveform-visible", "waveform-loading"])
        ]),
        createVNode(DanmuFactorySettingDailog, {
          visible: unref(xmlConvertVisible),
          "onUpdate:visible": _cache[8] || (_cache[8] = ($event) => isRef(xmlConvertVisible) ? xmlConvertVisible.value = $event : null),
          modelValue: unref(videoVCutOptions).danmuPresetId,
          "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => unref(videoVCutOptions).danmuPresetId = $event),
          "show-preset": true,
        ...
        createVNode(ExportModal, {
          ...
          "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => isRef(exportVisible) ? exportVisible.value = $event : null),
          files: unref(files)
        }, null, 8, ["modelValue", "files"]),
        createVNode(ExportUploadModal, {
          modelValue: unref(exportUploadVisible),
          "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => isRef(exportUploadVisible) ? exportUploadVisible.value = $event : null),
          files: unref(files),
          segment: unref(currentUploadSegment)
        }, null, 8, ["modelValue", "files", "segment"]),
        createVNode(WaveformAnalyzerDialog, {
          visible: unref(waveformAnalyzerDialogVisible),
          "onUpdate:visible": _cache[12] || (_cache[12] = ($event) => isRef(waveformAnalyzerDialogVisible) ? waveformAnalyzerDialogVisible.value = $event : null),
          modelValue: unref(waveformAnalyzerConfig),
          "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => isRef(waveformAnalyzerConfig) ? waveformAnalyzerConfig.value = $event : null),
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-47ac498c"]]);
export {
  Index as default
};
