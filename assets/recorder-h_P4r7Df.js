...
const douyuApiTypeOptions = [
  { label: "自动", value: "auto" },
  { label: "新接口", value: "newAPI" },
  { label: "旧接口", value: "oldAPI" }
];
const tiktokApiTypeOptions = [
  { label: "自动", value: "auto" },
  { label: "随机", value: "random" },
  { label: "web接口", value: "web" },
  { label: "直播html解析", value: "webHTML" }
...
export {
  ...
  biliStreamCodecOptions as d,
  douyuQualityOptions as e,
  douyuSourceOptions as f,
  douyuApiTypeOptions as g,
  douyuStreamCodecOptions as h,
  huyaQualityOptions as i,
  douyinStreamFormatOptions as j,
  huyaSourceOptions as k,
  huyaApiTypeOptions as l,
  douyinQualityOptions as m,
  douyinApiTypeOptions as n,
  tiktokQualityOptions as o,
  tiktokApiTypeOptions as p,
  qualityOptions as q,
