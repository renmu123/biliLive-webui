import { x as cB, p as c, z as cE, d as defineComponent, A as useConfig, d3 as useStyle, m as h, d4 as toHexaString, d5 as rgba, d6 as toHslaString, d7 as toHsvaString, d8 as toRgbaString, d9 as hsla, da as hsva, r as ref, l as computed, db as on, dc as off, K as createInjectionKey, j as inject, ab as watchEffect, dd as toHexString, de as toHslString, df as toRgbString, dg as toHsvString, a4 as warn, M as fadeInScaleUpTransition, y as cM, G as useTheme, O as useFormItem, R as provide, E as toRef, D as watch, I as useThemeClass, T as isMounted, $ as getPreciseEventTarget, V as Transition, W as withDirectives, X as clickoutside, dh as colorPickerLight, Y as call, aJ as createKey, B as Button, Q as nextTick } from "./index-B3txP6HV.js";
...
import { u as useAdjustedTo, B as Binder, V as VTarget, a as VFollower } from "./index-Be9rHucp.js";
...
const ColorInputUnit = defineComponent({
  ...
  render() {
    ...
    return h(__unplugin_components_2$1, {
      size: "small",
...
const ColorInput = defineComponent({
  ...
  render() {
    ...
    }, this.mode.toUpperCase() + (this.showAlpha ? "A" : "")), h(__unplugin_components_2, null, {
      default: () => {
        const {
          mode,
          valueArr,
