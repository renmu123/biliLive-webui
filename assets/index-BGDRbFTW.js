...
import { f as formatLength, h as useQueueStore, t as task, N as NIcon, d as __unplugin_components_2, _ as __unplugin_components_1$1 } from "./index-CEMlR3u9.js";
import { f as formatSeconds, d as deepRaw } from "./index-7WYu9wih.js";
import { T as TaskType } from "./enum-CKib_4fO.js";
import { x as c, z as cB, A as cM, d as defineComponent, p as computed, v as h, W as NBaseIcon, dQ as SuccessIcon, dR as ErrorIcon, dS as WarningIcon, dT as InfoIcon, D as useConfig, H as useTheme, dU as progressLight, aU as createKey, J as useThemeClass, o as openBlock, ah as createElementBlock, e as createBaseVNode, ai as createStaticVNode, b as unref, ap as toDisplayString, av as normalizeStyle, c as createBlock, w as withCtx, a as createVNode, am as createCommentVNode, a8 as Fragment, r as ref, i as isRef, an as renderList, B as Button, f as createTextVNode } from "./index--WEAc-yU.js";
import { C as CloseOutline } from "./CloseOutline-UsA4hmla.js";
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        ...
        _ctx.showInfo ? (openBlock(), createElementBlock("div", _hoisted_6, [
          ...
          unref(item).status === "running" ? (openBlock(), createElementBlock("span", _hoisted_8, "持续时间：" + toDisplayString(unref(formatSeconds)(unref(item).duration / 1e3)), 1)) : createCommentVNode("", true),
          unref(item).status === "running" ? (openBlock(), createElementBlock("span", _hoisted_9, " 预计还需：" + toDisplayString(unref(formatSeconds)(
...
const Item = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-b6226829"]]);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e3e2c741"]]);
export {
  index as default
};
