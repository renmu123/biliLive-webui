import { r as ref, x as computed, Q as useMemo, E as provide, d as defineComponent, S as inject, l as h, Z as VResizeObserver, a1 as mergeProps, an as useSsrAdapter, ae as onMounted, ak as onActivated, al as onDeactivated, J as toRef, ay as depx, bz as pxfy, a8 as nextTick, aB as renderSlot, cR as resizeObserverManager, bn as onBeforeUnmount, m as cB, q as cE, p as c$1, M as NBaseIcon, v as useConfig, y as useTheme, cS as emptyLight, av as createKey, C as useThemeClass, W as render, bf as Transition, n as cM, s as cNotM, be as fadeInScaleUpTransition, au as resolveWrappedSlot, bo as NBaseLoading, T as Scrollbar, aC as resolveSlot, A as useRtl, cT as internalSelectMenuLight, a5 as watch, aw as getMargin, ar as NBaseClose, cU as color2Class, cV as tagLight, G as call, D as createInjectionKey, cW as Wrapper, F as Fragment, cX as internalSelectionLight, a0 as watchEffect, H as withDirectives, K as vShow, bg as clickoutside, bh as useFormItem, bi as isMounted, cY as selectLight, bj as getPreciseEventTarget, bs as markEventEffectPerformed } from "./index-gjuLIDoI.js";
import { c, a as cssrAnchorMetaName, h as beforeNextFrameOnce, i as internalSelectionMenuInjectionKey, j as internalSelectionMenuBodyInjectionKey, _ as __unplugin_components_2$1, B as Binder, V as VTarget, f as VFollower, u as useAdjustedTo } from "./Popover-T5GorXob.js";
import { u as useLocale, N as NBaseSuffix } from "./Input--Gp3P9gj.js";
...
const NInternalSelectMenu = defineComponent({
  ...
  render() {
    ...
    return h("div", {
      ...
      "data-empty": true
    }, resolveSlot($slots.empty, () => [h(__unplugin_components_8, {
...
const NInternalSelection = defineComponent({
  ...
  render() {
    ...
    if (multiple) {
      ...
      body = h(Fragment, null, useMaxTagCount ? h(__unplugin_components_2$1, Object.assign({}, popoverProps, {
        scrollable: true,
