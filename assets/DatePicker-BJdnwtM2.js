import { cw as replaceable, l as h, cx as toDate, D as createInjectionKey, S as inject, x as computed, r as ref, a8 as nextTick, a5 as watch, cy as startOfWeek, d as defineComponent, T as Scrollbar, bt as XButton, L as resolveSlotWithProps, B as Button, ae as onMounted, bf as Transition, H as withDirectives, bj as getPreciseEventTarget, bg as clickoutside, aC as resolveSlot, aB as renderSlot, y as useTheme, p as c, m as cB, n as cM, be as fadeInScaleUpTransition, s as cNotM, q as cE, M as NBaseIcon, bh as useFormItem, v as useConfig, J as toRef, a0 as watchEffect, bd as warn, E as provide, C as useThemeClass, av as createKey, bi as isMounted, cz as datePickerLight, bs as markEventEffectPerformed, G as call } from "./index-gjuLIDoI.js";
import { s as setMonth, f as format, d as dateArray, m as monthArray, y as yearArray, q as quarterArray, g as getTime, a as addMonths, b as addYears, c as getMonth, e as getYear, h as setYear, i as strictParse, j as isValid, k as set, l as getDate, n as getDefaultTime, o as startOfSecond, p as startOfMonth, r as startOfYear, t as startOfQuarter, u as startOfDay, v as isSameMonth, w as getQuarterString, x as getMonthString, z as getYearString, A as pluckValueFromRange, _ as __unplugin_components_7, B as getHours, C as getMinutes, D as getSeconds } from "./TimePicker-6LkPrZvv.js";
import { u as useKeyboard } from "./create-ref-setter-DXkZaMbS.js";
import { c as VVirtualList, d as FocusDetector } from "./Select-xWcqChuz.js";
import { u as useLocale, _ as __unplugin_components_0$1 } from "./Input--Gp3P9gj.js";
import { B as Binder, V as VTarget, f as VFollower, u as useAdjustedTo } from "./Popover-T5GorXob.js";
import { F as FastBackwardIcon, B as BackwardIcon, a as ForwardIcon, b as FastForwardIcon } from "./Pagination-kMhNeoDI.js";
...
const __unplugin_components_0 = defineComponent({
  ...
  render() {
    ...
    return h("div", {
      ...
      default: () => [h(VTarget, null, {
        default: () => this.isRange ? h(__unplugin_components_0$1, Object.assign({
          ref: "inputInstRef",
        ...
        }) : h(__unplugin_components_0$1, Object.assign({
          ref: "inputInstRef",
          status: this.mergedStatus,
