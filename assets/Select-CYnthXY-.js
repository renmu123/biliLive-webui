import { r as ref, x as computed, Q as useMemo, E as provide, d as defineComponent, S as inject, l as h, aj as VResizeObserver, V as mergeProps, cg as useSsrAdapter, ax as onMounted, aC as onActivated, aD as onDeactivated, J as toRef, bB as depx, cy as pxfy, aq as nextTick, aF as renderSlot, dd as resizeObserverManager, Y as watch, Z as onBeforeUnmount, m as cB, q as cE, p as c$1, M as NBaseIcon, v as useConfig, y as useTheme, aO as createKey, C as useThemeClass, de as emptyLight, ag as render, U as Transition, n as cM, s as cNotM, br as fadeInScaleUpTransition, aL as resolveWrappedSlot, bA as NBaseLoading, W as Scrollbar, aG as resolveSlot, A as useRtl, df as internalSelectMenuLight, aN as getMargin, ad as NBaseClose, cp as color2Class, dg as tagLight, G as call, D as createInjectionKey, dh as Wrapper, F as Fragment, di as internalSelectionLight, X as watchEffect, H as withDirectives, K as vShow, $ as clickoutside, bs as useFormItem, a9 as isMounted, dj as selectLight, bt as getPreciseEventTarget, bF as markEventEffectPerformed } from "./index-CB8xvhFr.js";
import { f as c, g as cssrAnchorMetaName, i as beforeNextFrameOnce, j as internalSelectionMenuInjectionKey, k as internalSelectionMenuBodyInjectionKey, _ as __unplugin_components_2, B as Binder, V as VTarget, e as VFollower, u as useAdjustedTo } from "./Popover-D4v8saSe.js";
import { a as useLocale, N as NBaseSuffix, u as useMergedState } from "./Input-C3jgSm1V.js";
import { a as createIndexGetter, h as happensIn, c as createTreeMate } from "./create-DfXrl36C.js";
import { u as useCompitable } from "./Icon-D1o4HjX4.js";
function lowBit(n) {
  return n & -n;
}
class FinweckTree {
...
const NInternalSelectMenu = defineComponent({
  ...
  render() {
    ...
    return h("div", {
      ...
      var _a;
      return [((_a = this.mergedRenderEmpty) === null || _a === void 0 ? void 0 : _a.call(this)) || h(__unplugin_components_5, {
...
const style$1 = c$1([cB("base-selection", `
...
export {
  ...
  VVirtualList as b,
  FocusDetector as c,
  NInternalSelectMenu as d,
  createTmOptions as e,
  NInternalSelection as f,
