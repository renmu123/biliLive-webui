import { d as defineComponent, a2 as h, a3 as createInjectionKey, a4 as cB, a5 as inject, a6 as useConfig, a7 as useTheme, a8 as popselectLight, e as computed, a9 as createTreeMate, w as watch, aa as nextTick, ab as toRef, ac as useThemeClass, ad as NInternalSelectMenu, ae as keysOf, af as createTmOptions, ag as happensIn, ah as call, r as ref, ai as provide, aj as keep, ak as createRefSetter, al as mergeEventHandlers, am as omit, A as __unplugin_components_2, an as popoverBaseProps, ao as c, ap as cM, aq as cNotM, ar as paginationLight, as as useLocale, at as useMergedState, au as watchEffect, av as useRtl, aw as createKey, ax as resolveSlot, G as __unplugin_components_2$1, B as __unplugin_components_0$1, F as Fragment, ay as NBaseIcon, az as useAdjustedTo, aA as useFormItem, aB as dynamicTagsLight, aC as NTag, I as Button, aD as AddIcon, aE as __unplugin_components_4$1, aF as commonProps, m as mergeModels, s as storeToRefs, V as useAppConfig, c as useModel, u as useNotification, g as createBlock, h as withCtx, K as __unplugin_components_3, f as openBlock, i as createVNode, k as createBaseVNode, j as unref, q as isRef, l as createTextVNode, n as createElementBlock, aG as renderList, aH as normalizeClass, aI as toDisplayString, J as __unplugin_components_2$2, M as pushScopeId, O as popScopeId, P as _export_sfc, p as createCommentVNode, aJ as normalizeStyle, a as useConfirm, aK as useUploadPreset, o as onMounted, U as useUserInfoStore, Y as deepRaw, L as __unplugin_components_13, t as withKeys, x as cloneDeep, y as uuid, z as __unplugin_components_1, C as _sfc_main$3, _ as __unplugin_components_0$2, E as __unplugin_components_1$2 } from "./index--gUAYtmw.js";
...
const _withScopeId$1 = (n) => (pushScopeId("data-v-08516db7"), n = n(), popScopeId(), n);
const _hoisted_1$2 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("p", { style: { "color": "red" } }, "续传只会增加分p，不会对稿件进行编辑", -1));
const _hoisted_2$1 = { style: { "display": "flex", "gap": "10px", "align-items": "center" } };
const _hoisted_3$1 = { class: "media-container" };
                ...
                createBaseVNode("div", _hoisted_3$1, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(list), (item) => {
                    return openBlock(), createElementBlock("div", {
                      ...
                      createBaseVNode("div", _hoisted_6$1, toDisplayString(item.Archive.title), 1)
                    ], 10, _hoisted_4$1);
                  }), 128))
                ])
              ])
...
const AppendVideoDialog = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-08516db7"]]);
...
const __unplugin_components_4 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-d8f27eca"]]);
const _withScopeId = (n) => (pushScopeId("data-v-d4dad82e"), n = n(), popScopeId(), n);
const _hoisted_1 = { class: "inline-flex" };
const _hoisted_2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", null, "封面", -1));
const _hoisted_3 = { class: "inline-flex" };
const _hoisted_4 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", null, "话题", -1));
const _hoisted_5 = { class: "inline-flex" };
const _hoisted_6 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", null, "视频简介", -1));
...
const _hoisted_17 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "inline-flex" }, [
  /* @__PURE__ */ createBaseVNode("span", null, "自动评论")
], -1));
const _hoisted_18 = { class: "inline-flex" };
const _hoisted_19 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", null, "合集", -1));
const _hoisted_20 = {
  class: "inline-items",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const deletePreset = async () => {
      const appConfig2 = await window.api.config.getAll();
      let ids = Object.entries(appConfig2.webhook.rooms || {}).map(([, value]) => {
        return value?.uploadPresetId;
      });
      ids.push(appConfig2.webhook?.uploadPresetId);
            ...
            createVNode(_component_n_form_item, null, {
              label: withCtx(() => [
                createBaseVNode("span", _hoisted_1, [
                  _hoisted_2,
                  createVNode(_component_Tip, { tip: "默认使用视频第一帧" })
                ])
              ]),
              default: withCtx(() => [
...
const BiliSetting = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d4dad82e"]]);
export {
