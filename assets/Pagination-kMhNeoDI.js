import { d as defineComponent, l as h, D as createInjectionKey, m as cB, X as keysOf, v as useConfig, y as useTheme, S as inject, cA as popselectLight, x as computed, a5 as watch, J as toRef, C as useThemeClass, G as call, a8 as nextTick, as as omit, r as ref, Y as keep, E as provide, p as c, n as cM, s as cNotM, aC as resolveSlot, F as Fragment, M as NBaseIcon, a0 as watchEffect, A as useRtl, av as createKey, cB as paginationLight } from "./index-gjuLIDoI.js";
import { _ as __unplugin_components_0, u as useLocale } from "./Input--Gp3P9gj.js";
import { N as NInternalSelectMenu, e as createTmOptions, m as mergeEventHandlers, _ as __unplugin_components_0$1 } from "./Select-xWcqChuz.js";
import { _ as __unplugin_components_2, p as popoverBaseProps, u as useAdjustedTo } from "./Popover-T5GorXob.js";
import { c as createTreeMate, h as happensIn } from "./create-DfXrl36C.js";
import { c as createRefSetter } from "./create-ref-setter-DXkZaMbS.js";
      ...
      switch (part) {
        ...
        case "quick-jumper":
          return !simple && showQuickJumper ? h("div", {
            class: `${mergedClsPrefix}-pagination-quick-jumper`
          }, goto ? goto() : resolveSlot(this.$slots.goto, () => [locale.goto]), h(__unplugin_components_0, {
            value: jumperValue,
            onUpdateValue: handleJumperInput,
            size: inputSize,
            placeholder: "",
