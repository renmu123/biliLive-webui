import { j as bili, a as useUserInfoStore, d as useAppConfig, n as userApi, t as task } from "./index-FWk7a7hG.js";
import { p as c, m as cB, d as defineComponent, l as h, v as useConfig, y as useTheme, ca as themeLight, x as computed, C as useThemeClass, r as ref, ax as onMounted, X as watchEffect, al as mergeModels, am as useModel, Y as watch, g as createBlock, w as withCtx, ar as __unplugin_components_3, a as createVNode, e as createBaseVNode, h as createCommentVNode, t as toDisplayString, f as unref, j as createTextVNode, B as Button, _ as __unplugin_components_3$1, o as openBlock, an as storeToRefs, aC as onActivated, c as createElementBlock, F as Fragment, ao as renderList, i as isRef, ap as normalizeClass } from "./index-CB8xvhFr.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-uo42igUt.js";
import { s as showInput } from "./showInput-DT3gy469.js";
import { a as config } from "./common-1CgNZfMf.js";
import { p as useClipboard } from "./index-CMOU2boc.js";
...
async function verifyBiliKey(options) {
  if (!window.isWeb) {
    return true;
  }
  ...
  try {
    const result = await config.verifyBiliKey(key);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  emits: /* @__PURE__ */ mergeModels(["close", "confirm"], ["update:modelValue"]),
...
const BiliLoginDialog = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-7d9bf23b"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const allImportInput = ref(null);
    const showBiliKeyBlockedNotice = (reason) => {
      if (reason === "missing") {
        notice.error({
    ...
    const downloadJSON = async (name, data) => {
    ...
    const isBiliUser = (value) => {
      if (!value || typeof value !== "object") {
        return false;
      }
      const user = value;
      return typeof user.mid === "number" && typeof user.accessToken === "string" && typeof user.refreshToken === "string" && !!user.cookie && typeof user.cookie === "object";
    };
    const exportCurrentAccount = async (uid) => {
    ...
    const onImportAllFileChange = async (event) => {
      ...
      return openBlock(), createElementBlock("div", null, [
        createBaseVNode("div", _hoisted_1, [
          createBaseVNode("div", _hoisted_2, [
            ...
            createVNode(_component_n_button, { onClick: exportAllAccounts }, {
              default: withCtx(() => _cache[2] || (_cache[2] = [
                createTextVNode("导出用户")
              ])),
              _: 1
            }),
            createVNode(_component_n_button, { onClick: triggerImportAll }, {
              default: withCtx(() => _cache[3] || (_cache[3] = [
            ...
            createBaseVNode("input", {
              ref_key: "allImportInput",
              ref: allImportInput,
              type: "file",
              accept: "application/json",
              style: { "display": "none" },
              onChange: onImportAllFileChange
            }, null, 544)
          ])
        ]),
            ...
            return openBlock(), createElementBlock("div", {
              ...
              createVNode(_component_n_popover, {
                ...
                default: withCtx(() => [
                  ...
                  createBaseVNode("div", {
                    class: "section",
                    onClick: ($event) => updateAuth(item.uid)
                  }, "更新授权", 8, _hoisted_10),
                  createBaseVNode("div", {
                    class: "section",
                    onClick: ($event) => getCookie(item.uid)
                  }, "复制cookie", 8, _hoisted_11),
                  createBaseVNode("div", {
                    class: "section",
                    onClick: ($event) => exportCurrentAccount(item.uid)
                  }, "导出", 8, _hoisted_12),
                  createBaseVNode("div", {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-367638ee"]]);
export {
  index as default
};
