import { m as cB, bm as fadeInTransition, d as defineComponent, l as h, bf as Transition, a$ as useStyle, J as toRef, r as ref, bn as onBeforeUnmount, D as createInjectionKey, bo as NBaseLoading, M as NBaseIcon, S as inject, x as computed, Q as useMemo, T as Scrollbar, ay as depx, H as withDirectives, bg as clickoutside, aC as resolveSlot, au as resolveWrappedSlot, p as c, be as fadeInScaleUpTransition, q as cE, n as cM, v as useConfig, y as useTheme, bh as useFormItem, bp as isReactive, a5 as watch, E as provide, bi as isMounted, bq as changeColor, C as useThemeClass, br as cascaderLight, bs as markEventEffectPerformed, G as call, a8 as nextTick, bj as getPreciseEventTarget } from "./index-gjuLIDoI.js";
import { F as FinishedIcon, c as VVirtualList, d as FocusDetector, u as useOnResize, b as __unplugin_components_8, N as NInternalSelectMenu, e as createTmOptions, f as NInternalSelection } from "./Select-xWcqChuz.js";
...
import { u as useLocale } from "./Input--Gp3P9gj.js";
  ...
  render() {
    ...
    return h(Transition, {
      ...
      default: () => {
        ...
        }, resolveSlot(this.$slots.empty, () => [h(__unplugin_components_8, {
