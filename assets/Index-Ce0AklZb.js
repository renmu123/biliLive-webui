...
import { _ as __unplugin_components_2$1 } from "./Switch-pVA37h8S.js";
import { _ as __unplugin_components_4 } from "./InputNumber-MTAwVgRH.js";
import { _ as __unplugin_components_0 } from "./Select-BJZLKoNA.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-BTOCZhDw.js";
import { E as EllipsisHorizontalOutline } from "./EllipsisHorizontalOutline-DNMVWul7.js";
import { _ as __unplugin_components_2$3 } from "./Popover-BC17UgGB.js";
              ...
              createVNode(_component_n_form, {
                ...
                default: withCtx(() => [
                  ...
                  createVNode(_component_n_form_item, null, {
                    label: withCtx(() => [
                      createBaseVNode("span", _hoisted_1$2, [
                        _cache[23] || (_cache[23] = createTextVNode(" 发送至webhook ")),
                  ...
                  createVNode(_component_n_form_item, null, {
                    label: withCtx(() => [
                      createBaseVNode("span", _hoisted_2$2, [
                        _cache[24] || (_cache[24] = createTextVNode(" 分段录制 ")),
                  ...
                  createVNode(_component_n_form_item, null, {
                    ...
                    default: withCtx(() => [
                      _cache[31] || (_cache[31] = createTextVNode(" 待实现 ")),
                      createVNode(_component_n_checkbox, {
                  ...
                  _cache[38] || (_cache[38] = createBaseVNode("h2", null, "弹幕录制", -1)),
                  createVNode(_component_n_form_item, null, {
                    ...
                    default: withCtx(() => [
                      createVNode(_component_n_switch, {
                        ...
                        "onUpdate:value": _cache[11] || (_cache[11] = ($event) => unref(config).disableProvideCommentsWhenRecording = $event),
                      ...
                      createVNode(_component_n_checkbox, {
                        ...
                        "onUpdate:checked": _cache[12] || (_cache[12] = ($event) => unref(globalFieldsObj).disableProvideCommentsWhenRecording = $event),
                        class: "global-checkbox"
                      }, {
                  ...
                  !unref(config).disableProvideCommentsWhenRecording ? (openBlock(), createBlock(_component_n_form_item, { key: 2 }, {
                    ...
                    default: withCtx(() => [
                      createVNode(_component_n_switch, {
                        ...
                        "onUpdate:value": _cache[13] || (_cache[13] = ($event) => unref(config).saveGiftDanma = $event),
                        disabled: unref(globalFieldsObj).saveGiftDanma
                      }, null, 8, ["value", "disabled"]),
                      createVNode(_component_n_checkbox, {
                        checked: unref(globalFieldsObj).saveGiftDanma,
                        "onUpdate:checked": _cache[14] || (_cache[14] = ($event) => unref(globalFieldsObj).saveGiftDanma = $event),
                        class: "global-checkbox"
                      }, {
                  ...
                  !unref(config).disableProvideCommentsWhenRecording ? (openBlock(), createBlock(_component_n_form_item, { key: 3 }, {
                    ...
                    default: withCtx(() => [
                      createVNode(_component_n_switch, {
                        ...
                        "onUpdate:value": _cache[15] || (_cache[15] = ($event) => unref(config).saveSCDanma = $event),
                        disabled: unref(globalFieldsObj).saveSCDanma
                      }, null, 8, ["value", "disabled"]),
                      createVNode(_component_n_checkbox, {
                        checked: unref(globalFieldsObj).saveSCDanma,
                        "onUpdate:checked": _cache[16] || (_cache[16] = ($event) => unref(globalFieldsObj).saveSCDanma = $event),
                        class: "global-checkbox"
                      }, {
...
const addModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-3c90f2fc"]]);
const _hoisted_1$1 = {
...
const _hoisted_6 = { class: "source" };
const _hoisted_7 = { class: "line" };
const _hoisted_8 = { class: "content" };
const _hoisted_9 = ["src"];
const _hoisted_10 = { style: { "display": "flex", "flex-direction": "column", "justify-content": "space-between" } };
const _hoisted_11 = { style: { "display": "flex", "gap": "5px", "align-items": "center" } };
const _hoisted_12 = ["title"];
const _hoisted_13 = { class: "channel-id" };
  ...
  setup(__props) {
    ...
    const list = computed(() => {
      return recorderList.value.map((item) => {
        const liveInfo = liveInfos.value.find((liveInfo2) => liveInfo2.roomId === item.channelId);
        return {
          ...item,
    ...
    const getLiveInfo2 = async () => {
      ...
      liveInfos.value = await recoder.getLiveInfo(ids);
    };
    const init = async () => {
      await getList();
      await getLiveInfo2();
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[4] || (_cache[4] = createBaseVNode("p", null, "这并非是经过严格监测的录播工具，请谨慎在生产环境使用", -1)),
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(list), (item, index) => {
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", {
                ...
                item.roomTitle ? (openBlock(), createElementBlock("span", _hoisted_4, toDisplayString(item.roomTitle), 1)) : createCommentVNode("", true),
                item.state === "recording" ? (openBlock(), createElementBlock("div", _hoisted_5, [
                  _cache[2] || (_cache[2] = createBaseVNode("div", { class: "recording" }, null, -1)),
                  createBaseVNode("span", _hoisted_6, toDisplayString(item.usedSource), 1),
                  createBaseVNode("span", _hoisted_7, toDisplayString(item.usedStream), 1)
                ])) : createCommentVNode("", true)
              ], 4),
                ...
                createBaseVNode("div", _hoisted_10, [
                  createBaseVNode("div", _hoisted_11, [
                    createBaseVNode("div", {
                      class: "owner",
                      title: item.remarks
                    }, toDisplayString(item.owner), 9, _hoisted_12),
                  ...
                  createBaseVNode("div", _hoisted_13, [
                    _cache[3] || (_cache[3] = createTextVNode(" 房间号：")),
                    createBaseVNode("a", {
                      class: "link",
                      target: "_blank",
                      href: item.channelURL
                    }, toDisplayString(item.channelId), 9, _hoisted_14)
                  ])
                ])
              ]),
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7ac8f7bd"]]);
export {
  Index as default
};
