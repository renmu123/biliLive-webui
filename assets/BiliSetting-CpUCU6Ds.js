import { e as useAppConfig, k as useUploadPreset, b as useUserInfoStore, v as videoPreset, c as cloneDeep, _ as __unplugin_components_1$2 } from "./index-CEMlR3u9.js";
import { d as defineComponent, v as h, N as createInjectionKey, z as cB, m as inject, D as useConfig, H as useTheme, b4 as popselectLight, p as computed, F as watch, T as nextTick, G as toRef, J as useThemeClass, ac as keysOf, $ as call, r as ref, U as provide, ab as keep, aX as omit, x as c, A as cM, P as cNotM, b5 as paginationLight, ae as watchEffect, b6 as useRtl, aU as createKey, b7 as resolveSlot, a8 as Fragment, W as NBaseIcon, Q as useFormItem, b8 as dynamicTagsLight, B as Button, aj as mergeModels, al as storeToRefs, ak as useModel, c as createBlock, w as withCtx, aq as __unplugin_components_3, o as openBlock, a as createVNode, e as createBaseVNode, b as unref, i as isRef, f as createTextVNode, ah as createElementBlock, an as renderList, ao as normalizeClass, ap as toDisplayString, _ as __unplugin_components_2$2, am as createCommentVNode, av as normalizeStyle, E as onMounted, az as withKeys } from "./index--WEAc-yU.js";
import { b as bili } from "./bili-CEzfPkaF.js";
import { u as useLocale } from "./Suffix-BQ4ungoP.js";
import { a as useMergedState, u as useNotification } from "./use-notification-kPOG22iR.js";
import { _ as __unplugin_components_2$1 } from "./Input-e5p23sTB.js";
import { _ as __unplugin_components_0$1 } from "./Select-BJZLKoNA.js";
import { _ as __unplugin_components_2, p as popoverBaseProps, u as useAdjustedTo } from "./Popover-BC17UgGB.js";
import { c as createTreeMate, N as NInternalSelectMenu, a as createTmOptions, h as happensIn, m as mergeEventHandlers, b as NTag, d as commonProps } from "./utils-gbHn4zNK.js";
...
import { _ as _sfc_main$3 } from "./Tip.vue_vue_type_script_setup_true_lang-CneJYjyB.js";
import { d as deepRaw, u as uuid } from "./index-7WYu9wih.js";
import { u as useConfirm } from "./index-DrmsQ8d7.js";
import { A as AddIcon, a as __unplugin_components_7, _ as __unplugin_components_1 } from "./FormItem-C0YLffRX.js";
import { _ as __unplugin_components_4$1 } from "./Space-TxRUr9lU.js";
import { _ as __unplugin_components_1$1 } from "./Divider-BFHxE5jd.js";
import { _ as __unplugin_components_3$1, a as __unplugin_components_5 } from "./RadioGroup-CQ9oU1B4.js";
import { _ as __unplugin_components_0$2 } from "./Cascader-yfeRzFJx.js";
...
const NPopselectPanel = defineComponent({
  ...
  setup(props) {
    ...
    const themeRef = useTheme("Popselect", "-pop-select", style$2, popselectLight, NPopselect2.props, mergedClsPrefixRef);
...
const __unplugin_components_0 = defineComponent({
  ...
  setup(props) {
    ...
    const themeRef = useTheme("Pagination", "-pagination", style$1, paginationLight, props, mergedClsPrefixRef);
    const {
      localeRef
...
const __unplugin_components_10 = defineComponent({
  ...
  render() {
    ...
    onRender === null || onRender === void 0 ? void 0 : onRender();
    return h(__unplugin_components_4$1, {
      ...
      default: () => {
        ...
        }) : h(__unplugin_components_2$1, Object.assign({
          placeholder: "",
          size: inputSize,
          style: inputStyle,
          class: inputClass,
...
const _hoisted_1$2 = { style: { "display": "flex", "gap": "10px", "align-items": "center" } };
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const confirm = async () => {
      ...
      const res = await bili.getPlatformArchiveDetail(Number(aid.value), appConfig.value.uid);
      if (res.in_season) {
        notice.error({
...
const AppendVideoDialog = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-97f8adf2"]]);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const src = useModel(__props, "modelValue");
    const props = __props;
      ...
      return openBlock(), createElementBlock("div", null, [
        ...
        createBaseVNode("div", {
          ...
          src.value ? (openBlock(), createElementBlock("img", {
            ...
            src: src.value,
            onClick: selectImage
          }, null, 8, _hoisted_1$1)) : (openBlock(), createElementBlock("div", {
            key: 1,
            class: "empty-image",
            onClick: selectImage
          }, "选择图片")),
          src.value ? (openBlock(), createElementBlock("span", {
            key: 2,
            class: "remove",
            onClick: remove
...
const __unplugin_components_4 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-243f8c09"]]);
...
const _hoisted_5 = { class: "inline-items" };
const _hoisted_6 = { class: "inline-item" };
const _hoisted_7 = { class: "inline-item" };
const _hoisted_8 = { class: "inline-items" };
...
const _hoisted_13 = { class: "inline-items" };
const _hoisted_14 = { class: "inline-flex" };
const _hoisted_15 = {
  class: "inline-items",
  ...
  setup(__props, { emit: __emit }) {
    ...
    const handleTagChange = async (tags) => {
      if (tags.length !== 0) {
        ...
        const res = await bili.checkTag(tags[tags.length - 1], appConfig.value.uid);
        if (res.code !== 0) {
          notice.error({
            title: res.message,
            duration: 1e3
    ...
    const getTypeDesc = async (tid) => {
      if (!userInfoStore?.userInfo?.uid) {
        return;
      }
      const data = await bili.getTypeDesc(tid, userInfoStore.userInfo.uid);
      if (data) {
        descMaxLength.value = 2e3;
      } else {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_n_dynamic_tags = __unplugin_components_10;
      ...
      return openBlock(), createElementBlock("div", null, [
        createVNode(_component_n_form, {
          ...
          default: withCtx(() => [
            createVNode(_component_n_form_item, { label: "预设" }, {
              default: withCtx(() => [
                createVNode(_component_n_select, {
                  ...
                  "onUpdate:value": [
                    _cache[0] || (_cache[0] = ($event) => presetId.value = $event),
                    handlePresetChange
                  ],
            ...
            createVNode(_component_n_form_item, null, {
              label: withCtx(() => [
                createBaseVNode("span", _hoisted_1, [
                  _cache[28] || (_cache[28] = createBaseVNode("span", null, "封面", -1)),
                  createVNode(_component_Tip, { tip: "非必选，默认由B站决定" })
                ])
              ]),
              default: withCtx(() => [
            ...
            createVNode(_component_n_form_item, { label: "稿件类型" }, {
              default: withCtx(() => [
                createVNode(_component_n_radio_group, {
                  ...
                  "onUpdate:value": _cache[3] || (_cache[3] = ($event) => unref(options).config.copyright = $event),
                  name: "radiogroup"
                }, {
                  default: withCtx(() => [
            ...
            unref(options).config.copyright === 2 ? (openBlock(), createBlock(_component_n_form_item, {
              ...
              default: withCtx(() => [
                createVNode(_component_n_input, {
                  ...
                  "onUpdate:value": _cache[4] || (_cache[4] = ($event) => unref(options).config.source = $event),
            ...
            createVNode(_component_n_form_item, { label: "分区" }, {
              default: withCtx(() => [
                createVNode(_component_n_cascader, {
                  ...
                  "onUpdate:value": _cache[5] || (_cache[5] = ($event) => unref(options).config.tid = $event),
                  "label-field": "name",
                  "value-field": "id",
            ...
            createVNode(_component_n_form_item, { label: "标签" }, {
              default: withCtx(() => [
                createVNode(_component_n_dynamic_tags, {
                  value: unref(options).config.tag,
                  "onUpdate:value": [
                    _cache[6] || (_cache[6] = ($event) => unref(options).config.tag = $event),
                    handleTagChange
                  ],
                  max: 12
                }, null, 8, ["value"])
            ...
            unref(options).config.copyright === 1 ? (openBlock(), createBlock(_component_n_form_item, { key: 1 }, {
              label: withCtx(() => [
                createBaseVNode("span", _hoisted_2, [
                  _cache[31] || (_cache[31] = createBaseVNode("span", null, "话题", -1)),
                  createVNode(_component_Tip, { tip: "话题也会占据一个tag栏~" })
                ])
              ]),
              default: withCtx(() => [
                createVNode(_component_n_select, {
                  value: unref(options).config.topic_name,
                  "onUpdate:value": _cache[7] || (_cache[7] = ($event) => unref(options).config.topic_name = $event),
                  filterable: "",
                  placeholder: "搜索话题",
            ...
            createVNode(_component_n_form_item, null, {
              label: withCtx(() => [
                createBaseVNode("span", _hoisted_3, [
                  _cache[32] || (_cache[32] = createBaseVNode("span", null, "视频简介", -1)),
                  createVNode(_component_Tip, { tip: "可以输入[暮色312]<10995238>来进行艾特用户，前面的值为用户名，后面的值为用户id，请务必保持用户名与id对应。" })
                ])
              ]),
              default: withCtx(() => [
                createVNode(_component_n_input, {
                  value: unref(options).config.desc,
                  "onUpdate:value": _cache[8] || (_cache[8] = ($event) => unref(options).config.desc = $event),
                  placeholder: "请输入视频简介",
                  clearable: "",
            ...
            createVNode(_component_n_form_item, { label: "粉丝动态" }, {
              default: withCtx(() => [
                createVNode(_component_n_input, {
                  ...
                  "onUpdate:value": _cache[9] || (_cache[9] = ($event) => unref(options).config.dynamic = $event),
                  placeholder: "请输入粉丝动态",
                  clearable: "",
                  maxlength: "233",
                  "show-count": "",
              ...
              default: withCtx(() => [
                createBaseVNode("div", _hoisted_4, [
                  createVNode(_component_n_checkbox, {
                    ...
                    "onUpdate:checked": _cache[10] || (_cache[10] = ($event) => unref(options).config.noReprint = $event),
                    "checked-value": 1,
                    "unchecked-value": 0
                  }, {
                  ...
                  createVNode(_component_n_checkbox, {
                    ...
                    "onUpdate:checked": _cache[11] || (_cache[11] = ($event) => unref(options).config.recreate = $event),
                    "checked-value": 1,
                    "unchecked-value": -1,
            ...
            createVNode(_component_n_form_item, { label: "充电设置" }, {
              default: withCtx(() => [
                createVNode(_component_n_checkbox, {
                  ...
                  "onUpdate:checked": _cache[12] || (_cache[12] = ($event) => unref(options).config.openElec = $event),
                  "checked-value": 1,
                  "unchecked-value": 0
                }, {
                ...
                createBaseVNode("div", _hoisted_5, [
                  createBaseVNode("div", _hoisted_6, [
                    createVNode(_component_n_checkbox, {
                      ...
                      "onUpdate:checked": _cache[13] || (_cache[13] = ($event) => unref(options).config.dolby = $event),
                      "checked-value": 1,
                      "unchecked-value": 0
                    }, {
                  ...
                  createBaseVNode("div", _hoisted_7, [
                    createVNode(_component_n_checkbox, {
                      ...
                      "onUpdate:checked": _cache[14] || (_cache[14] = ($event) => unref(options).config.hires = $event),
                      "checked-value": 1,
                      "unchecked-value": 0
                    }, {
                ...
                createBaseVNode("div", _hoisted_8, [
                  createBaseVNode("div", _hoisted_9, [
                    createVNode(_component_n_checkbox, {
                      ...
                      "onUpdate:checked": _cache[15] || (_cache[15] = ($event) => unref(options).config.closeDanmu = $event),
                      "checked-value": 1,
                      "unchecked-value": 0
                    }, {
                  ...
                  createBaseVNode("div", _hoisted_10, [
                    createVNode(_component_n_checkbox, {
                      ...
                      "onUpdate:checked": _cache[16] || (_cache[16] = ($event) => unref(options).config.closeReply = $event),
                      "checked-value": 1,
                      "unchecked-value": 0
                    }, {
                  ...
                  createBaseVNode("div", _hoisted_11, [
                    createVNode(_component_n_checkbox, {
                      ...
                      "onUpdate:checked": _cache[17] || (_cache[17] = ($event) => unref(options).config.selectiionReply = $event),
                      "checked-value": 1,
                      "unchecked-value": 0
                    }, {
                  ...
                  createBaseVNode("div", _hoisted_12, [
                    createVNode(_component_n_radio_group, {
                      ...
                      "onUpdate:value": _cache[18] || (_cache[18] = ($event) => unref(options).config.is_only_self = $event),
                      name: "radiogroup"
                    }, {
                      default: withCtx(() => [
                        createVNode(_component_n_space, null, {
            ...
            createVNode(_component_n_form_item, { label: "自动评论" }, {
              default: withCtx(() => [
                createBaseVNode("div", _hoisted_13, [
                  createVNode(_component_n_checkbox, {
                    checked: unref(options).config.autoComment,
                    "onUpdate:checked": _cache[19] || (_cache[19] = ($event) => unref(options).config.autoComment = $event),
                  ...
                  createVNode(_component_n_checkbox, {
                    ...
                    "onUpdate:checked": _cache[20] || (_cache[20] = ($event) => unref(options).config.commentTop = $event)
                  }, {
            ...
            unref(options).config.autoComment ? (openBlock(), createBlock(_component_n_form_item, { key: 2 }, {
              label: withCtx(() => _cache[45] || (_cache[45] = [
              ...
              default: withCtx(() => [
                createVNode(_component_n_input, {
                  ...
                  "onUpdate:value": _cache[21] || (_cache[21] = ($event) => unref(options).config.comment = $event),
                  placeholder: "请输入评论内容",
                  clearable: "",
                  maxlength: 1e3,
                  "show-count": "",
            ...
            createVNode(_component_n_form_item, null, {
              label: withCtx(() => [
                createBaseVNode("span", _hoisted_14, [
                  _cache[46] || (_cache[46] = createBaseVNode("span", null, "合集", -1)),
                  createVNode(_component_Tip, {
                    tip: `多p视频无法加入，仅适用于设置合集的账户(${unref(options).config.uid})，需电磁力3级才可开通`
                  }, null, 8, ["tip"])
                ])
              ]),
              default: withCtx(() => [
                createBaseVNode("div", _hoisted_15, [
                  createVNode(_component_n_select, {
                    ...
                    "onUpdate:value": _cache[22] || (_cache[22] = ($event) => unref(options).config.seasonId = $event),
                  ...
                  unref(options).config.seasonId ? (openBlock(), createBlock(_component_n_select, {
                    ...
                    "onUpdate:value": _cache[23] || (_cache[23] = ($event) => unref(options).config.sectionId = $event),
                  ...
                  unref(options).config.seasonId ? (openBlock(), createBlock(_component_n_checkbox, {
                    ...
                    "onUpdate:checked": _cache[24] || (_cache[24] = ($event) => unref(options).config.no_disturbance = $event),
                    "checked-value": 1,
                    "unchecked-value": 0,
                    style: { "flex": "none" }
                  }, {
        ...
        createVNode(_component_n_modal, {
          ...
          "onUpdate:show": _cache[27] || (_cache[27] = ($event) => isRef(nameModelVisible) ? nameModelVisible.value = $event : null)
        }, {
          default: withCtx(() => [
            createVNode(_component_n_card, {
              style: { "width": "600px" },
              ...
              footer: withCtx(() => [
                createBaseVNode("div", _hoisted_17, [
                  createVNode(_component_n_button, {
                    onClick: _cache[26] || (_cache[26] = ($event) => nameModelVisible.value = false)
                  }, {
              ...
              default: withCtx(() => [
                createVNode(_component_n_input, {
                  ...
                  "onUpdate:value": _cache[25] || (_cache[25] = ($event) => isRef(tempPresetName) ? tempPresetName.value = $event : null),
                  placeholder: "请输入预设名称",
                  maxlength: "15",
...
const BiliSetting = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b1ef4ab0"]]);
export {
