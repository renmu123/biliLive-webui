import { B as Binder, V as VTarget, e as VFollower, r as renderArrow, _ as __unplugin_components_2, p as popoverBaseProps } from "./Popover-D4v8saSe.js";
import { r as ref, Y as watch, D as createInjectionKey, d as defineComponent, l as h, ag as render, S as inject, V as mergeProps, U as Transition, x as computed, Q as useMemo, a3 as popoverBodyInjectionKey, E as provide, F as Fragment, bq as warn, b5 as XScrollbar, a4 as modalBodyInjectionKey, a2 as drawerBodyInjectionKey, m as cB, br as fadeInScaleUpTransition, p as c, s as cNotM, n as cM, q as cE, ai as keep, J as toRef, v as useConfig, y as useTheme, aO as createKey, C as useThemeClass, d6 as dropdownLight, G as call } from "./index-CB8xvhFr.js";
...
import { u as useKeyboard, c as createRefSetter } from "./create-ref-setter-slkfdNqs.js";
...
const __unplugin_components_5 = defineComponent({
  ...
  render() {
    ...
    return h(__unplugin_components_2, Object.assign({}, keep(this.$props, popoverPropKeys), popoverProps), {
      trigger: () => {
        var _a, _b;
