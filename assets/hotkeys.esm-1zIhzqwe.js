import { a4 as cB, ap as cM, d as defineComponent, a6 as useConfig, a7 as useTheme, e as computed, ac as useThemeClass, dn as useCompitable, a2 as h, dp as typographyLight, aw as createKey, f as openBlock, n as createElementBlock, k as createBaseVNode, m as mergeModels, c as useModel, r as ref, dq as useDropZone, F as Fragment, aG as renderList, i as createVNode, h as withCtx, aI as toDisplayString, c0 as renderSlot, aH as normalizeClass, j as unref, aJ as normalizeStyle, N as NIcon, cF as withModifiers, l as createTextVNode, P as _export_sfc } from "./index--gUAYtmw.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    function onDrop(files) {
      if (files) {
        let items = Array.from(files).map((file) => window.api.formatFile(file.path)).filter((file) => !fileList.value.map((item) => item.path).includes(file.path)).filter((file) => {
...
const __unplugin_components_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4e2cec5b"]]);
